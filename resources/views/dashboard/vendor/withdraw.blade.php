                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <input name="amount" type="number" class="form-control" requiredd=""
                                                    data-parsley-required-message="Amount is required" minn="10000"
                                                    data-parsley-min-message="Amount is required" placeholder=""
                                                    value="">
                                                @error('amount')
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <input name="" type="" class="form-control" placeholder=""
                                                    readonly
                                                    value=" @if (Auth::user()->dom_acc_verified) {{ Auth::user()->dom->name }} @endif">
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <input name="" type="" class="form-control" placeholder=""
                                                    readonly
                                                    value=" @if (Auth::user()->dom_acc_verified) {{ Auth::user()->dom_acc_number }} @endif">
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <input name="" type="" class="form-control" placeholder=""
                                                    readonly
                                                    value=" @if (Auth::user()->dom_acc_verified) {{ Auth::user()->dom_acc_name }} @endif">
                                            </div>
                                        </div>
