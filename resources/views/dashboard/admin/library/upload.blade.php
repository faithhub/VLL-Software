                                ...
                                <div id="law_upload">
                                    <form method="POST" action="{{ route('admin.upload') }}" class="validate-form"
                                        ...
                                        <div class="row mt-5 mb-5 settings">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                <div class="form-group">
                                                    <label class="form-label">Title of Law
                                                        <span>*<span></label>
                                                    <input type="text" class="form-control" name="title"
                                                        value="{{ old('title') }}" requiredd=""
                                                        data-parsley-required-message="Title of Law is required"
                                                        placeholder="">
                                                    @error('title')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                <div class="form-group">
                                                    <label class="form-label">Upload Material <span
                                                            id="material_file_text3">PDF</span>
                                                        <span>*<span></label>
                                                    <label class="btn btn-primary btn-block custom-file-upload">
                                                        <input requiredd="" accept="application/pdf"
                                                            name="material_file_id" id="material_file3"
                                                            data-parsley-errors-container="#material-file-error"
                                                            type="file" />
                                                        <i class="fa fa-upload">&nbsp</i>
                                                        <span id="file_text3">Upload Material
                                                            in
                                                            PDF</span>
                                                    </label>
                                                    <div id="material_file_preview3" style="display: none">
                                                        <div class="main-chat-header">
                                                            <div class="main-chat-msg-name">
                                                                <h6 id="material_file_name3"></h6>
                                                                <small id="material_file_size3"></small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <span class="invalid-feedback" id="material-file-error" role="alert">
