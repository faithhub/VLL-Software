                ...
                <div class="card border-10 pt-5">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <form method="POST" action="{{ route('admin.edit.library', $material['id']) }}" class="validate-form"
                            ...
                            @csrf
                            <input type="hiddenn" name="material_type_value" value="" id="material_type_value">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group settings">
                                        ...
                                        <select requiredd="" class="form-control select2"
                                            ...
                                            <option value=""></option>
                                            <option value="Paid"
                                                {{ $material['price'] ?? '' == 'Paid' ? 'selected' : '' }}>Paid
                                            </option>
                                            <option value="Free"
                                                {{ $material['price'] ?? '' == 'Free' ? 'selected' : '' }}>Free
                                            </option>
                                        </select>
                                        @error('price')
                                            <span class="invalid-feedback" role="alert">
                                            ...
                                            <select class="form-control select2 select" name="folder_id"
                                                ...
                                                @isset($folders)
                                                    @foreach ($folders as $item)
                                                        <option  data-value="{{ $item->material_type_id }}" value="{{ $item->id }}"
                                        ...
                                        <select class="form-control select" name="university_id" id="university_id"
                                            ...
                                            @isset($universities)
                                                @foreach ($universities as $item)
                                                    <option data-value="{{ $item->country_id }}" value="{{ $item->id }}" @selected($material->university_id == $item->id)>
                                                        {{ $item->name }}
                                                    </option>
                                                @endforeach
                                            @endisset
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" data-parsley-required-message="Material Description is required" requiredd=""
                                            name="material_desc" rows="8">{{ $material['material_desc'] }}</textarea>
                                        @error('material_desc')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
