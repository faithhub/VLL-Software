                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="card-header border-bottom-0 mb-4">
                                        ...
                                        <div class="card-options" style="margin-right:2.5%"> <a
                                                href="javascript:void(0);{{ $materials_types[0]['type']['id'] }}"
                                                class="btn btn-sm btn-primary">View All</a> </div>
                                    </div>
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            @isset($materials_types)
                                                {{-- {{ var_dump($materials_types)}} --}}
                                                @foreach ($materials_types as $material)
                                                    <div class="col-lg-3 col-md-3 mb-5 justify-content-center">
                                                        ...
                                                        <div class="mat-title">
                                                            ...
                                                            <a onclick="shiNew(event)" data-type="dark" data-size="l"
                                                                ...
                                                                <h4>{{ $material->title }} ({{ $material->year_of_publication }})
                                                                </h4>
