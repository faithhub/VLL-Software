...
You have been invited to {{ Auth::user()->name }}'s team as a member. As a team member, you have access to all books, and research notes in {{ Auth::user()->name }}'s library.
