                ...
                <div class="form-inline">
                    <div class="search-element">
                        @if (request()->is('user/library'))
                            <form action="" method="GET">
                                <input type="search" name="search"
                                    class="form-control header-search mobile-view-search" placeholder="Search Library"
                        ...
                        @if (request()->is('user'))
                            <form action="" method="GET">
                                <input type="search" name="search"
                                    class="form-control header-search mobile-view-search" placeholder="Search Bookstore"
                                    aria-label="Search" tabindex="1">
                                <button class="btn btn-primary-color">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="header-icon search-icon"
                                        width="24" height="24" viewBox="0 0 24 24">
                        ...
                        <div class="d-flex order-lg-2">
                            <div class="dropdown country-selector d-flex"> <a href="javascript:void(0);"
                                    ...
                                    <span class="header-avatar1">
                                        <img @if (Auth::user()->currency->id) src="{{ asset(Auth::user()->currency->flag) }}" 
                                            @elseif ($app_default_currency)
                                                src="{{ asset($app_default_currency->flag) }}" @endif
                                            alt="img" class="mb-1 country">&nbsp;
                            ...
                            <div class="dropdown profile-dropdown d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
                                    ...
                                    @if (Auth::user()->role == 'user')
                                        ...
                                        <a class="dropdown-item d-flex" href="{{ route('user.change-password') }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20"
                                                height="20" viewBox="0,0,256,256">
                                                <g fill-opacity="0.32941" fill="#000000" fill-rule="nonzero"
                                                    ...
                                                    <g transform="scale(10.66667,10.66667)">
                                                        <path
                                                            d="M12,1c-3.364,0 -6,2.636 -6,6v1c-1.1,0 -2,0.9 -2,2v10c0,1.1 0.9,2 2,2h12c1.1,0 2,-0.9 2,-2v-10c0,-1.1 -0.9,-2 -2,-2v-1c0,-3.364 -2.636,-6 -6,-6zM12,3c2.243,0 4,1.757 4,4v1h-8v-1c0,-2.243 1.757,-4 4,-4zM6,10h12v10h-12zM8,14c-0.55228,0 -1,0.44772 -1,1c0,0.55228 0.44772,1 1,1c0.55228,0 1,-0.44772 1,-1c0,-0.55228 -0.44772,-1 -1,-1zM12,14c-0.55228,0 -1,0.44772 -1,1c0,0.55228 0.44772,1 1,1c0.55228,0 1,-0.44772 1,-1c0,-0.55228 -0.44772,-1 -1,-1zM16,14c-0.55228,0 -1,0.44772 -1,1c0,0.55228 0.44772,1 1,1c0.55228,0 1,-0.44772 1,-1c0,-0.55228 -0.44772,-1 -1,-1z">

                                                        </path>
                                                    </g>
                                                </g>
                                            </svg>&nbsp;
                                            <div class="fs-13">Change Password</div>
                                        </a>
                                    @endif
                                    @if (Auth::user()->role == 'vendor')
                                        ...
                                        <a class="dropdown-item d-flex" href="{{ route('vendor.change-password') }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20"
                                                height="20" viewBox="0,0,256,256">
                                                <g fill-opacity="0.32941" fill="#000000" fill-rule="nonzero"
                                                    stroke="none" stroke-width="1" stroke-linecap="butt"
                                    ...
                                    @if (Auth::user()->role == 'teacher')
                                        <a class="dropdown-item d-flex" href="{{ route('teacher.settings') }}">
                                            <svg class="header-icon me-2" xmlns="http://www.w3.org/2000/svg"
                                                height="24" viewBox="0 0 24 24" width="24">
                                                <path d="M0 0h24v24H0V0z" fill="none"></path>
                                                <path
                                        ...
                                        <a class="dropdown-item d-flex" href="{{ route('teacher.change-password') }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20"
                                                height="20" viewBox="0,0,256,256">
                                                <g fill-opacity="0.32941" fill="#000000" fill-rule="nonzero"
                                                    stroke="none" stroke-width="1" stroke-linecap="butt"
                                    ...
                                    @if (Auth::user()->role == 'admin')
                                        ...
                                        <a class="dropdown-item d-flex" href="{{ route('admin.change-password') }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20"
                                                height="20" viewBox="0,0,256,256">
                                                <g fill-opacity="0.32941" fill="#000000" fill-rule="nonzero"
                                                    stroke="none" stroke-width="1" stroke-linecap="butt"
                                    ...
                                    @if (Auth::user()->role == 'sub_admin')
                                        <a class="dropdown-item d-flex"
                                            href="{{ route('admin.sub_admin_profile') }}">
                                            <svg class="header-icon me-2" xmlns="http://www.w3.org/2000/svg"
                                                height="24" viewBox="0 0 24 24" width="24">
                                                <path d="M0 0h24v24H0V0z" fill="none"></path>
                                                <path
