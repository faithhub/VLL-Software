...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'sub_admin_trans' => \App\Http\Middleware\SubAdminTrans::class,
        'sub_admin_user' => \App\Http\Middleware\SubAdminUser::class,
        'sub_admin_chat' => \App\Http\Middleware\SubAdminChat::class,
        'sub_admin_mat' => \App\Http\Middleware\SubAdminMaterial::class,
